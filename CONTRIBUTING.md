# Contributing to opencode-branch-guard

Thank you for considering contributing to opencode-branch-guard! Before diving in, please read these guidelines carefully.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/opencode-branch-guard.git
   ```
...
Every contribution makes a real difference. Thank you for taking the time to improve opencode-branch-guard.
